...
{
	ConstrainPlayer(15 + mapOffset_x + mapFineOffset_x, 100 + mapOffset_x + mapFineOffset_x, 20 + mapOffset_y + mapFineOffset_y, 75 + mapOffset_y + mapFineOffset_y, 1.5, camera);
    interDT = dt;
